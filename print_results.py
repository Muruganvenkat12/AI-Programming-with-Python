...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("{}: {}".format('Number of Images', results_stats_dic['n_images']))
    print("{}: {}".format('Number of Dog Images', results_stats_dic['n_dogs_img']))
        ...
        if results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']:
            ...
            for key in results_dic:
                if results_dic[key][3] == 1 and results_dic[key][4] == 0:
                    print("Image {} classified incorrectly as {}".format(key,results_stats_dic[key][1]))
